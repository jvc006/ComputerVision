...
lenaDiff = cv2.normalize(lenaDiff, -1, alpha=0, beta=255, norm_type=cv2.NORM_MINMAX)
...
logEdgesShow = cv2.normalize(logEdges, -1, alpha=0, beta=255, norm_type=cv2.NORM_MINMAX)
